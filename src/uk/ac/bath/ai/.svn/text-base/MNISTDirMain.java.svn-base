 ...
 * @author pjl
 */
public class MNISTDirMain extends JFrame {
				...
				if (task.isDone() && !done) {
					...
					if (loadCount == 0) {
						try {
							...
							Logger.getLogger(MNISTDirMain.class.getName()).log(
	...
	private static void createAndShowGUI() throws FileNotFoundException,
		...
		File dir = new File("/home/pjl/mnisnt/train");
		...
		dir = new File("/home/pjl/mnisnt/test");
