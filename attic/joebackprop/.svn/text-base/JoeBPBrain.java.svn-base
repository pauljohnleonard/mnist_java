...
import jahuwaldt.tools.NeuralNets.FeedForwardNetBP;
 ...
 * @author pjl
 */
public class JoeBPBrain extends AbstractBrain implements BatchTrainable {

    FeedForwardNetBP myFFNet2;
    private int n;
    private Image[] imagination;
    private ImageLabel reality;
    static int nLabels = 10;

    public JoeBPBrain(Dimension d) {
...
//        layerSizes=new int[]{n,nHidden,20,10};
        ...
        myFFNet2 = new FeedForwardNetBP(n, nLabels, 1, nHidden, new BasicNeuronFactory());
